...
class AddressSemantics(BaseModel):
    ...
    @staticmethod
    def from_mongo_record(raw_address_semantics: Dict, database):
        ...
        address = raw_address_semantics["address"]
        chain_id = raw_address_semantics["chain_id"]
        name = raw_address_semantics.get("name", raw_address_semantics["address"])
